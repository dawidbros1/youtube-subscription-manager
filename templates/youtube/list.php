<div id="list">
   <div class="row header">
      <div class="col-6 list-handle border-end">
         <?= $category->getName() ?>
      </div>
      ...
      <?php foreach ($subscriptionInCategory as $key => $channel): ?>
         <div class="row list-item">
            ...
            <div class="details col-7 col-sm-6 col-md-8 col-xl-10">
               <div class="row">
                  <div class="title col-12 fw-bold mb-2">
                     <?= $channel->snippet->title ?>
                  </div>
                  <div class="col-12">
                     <?= $channel->snippet->shortDescription; ?>
                  </div>
               </div>
            </div>
            <div class="col-2 col-sm-3 col-md-2 col-xl-1">
               <form action="<?= $route->get('channel.delete') ?>" method="post">
                  <input type="hidden" name="id" value="<?= $channels[$key]->getId() ?>">
